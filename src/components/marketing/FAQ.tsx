...
const faqs = [
  ...
  ["How does AI Assistant handle my writing?", "It is optional and works with your own OpenAI, Anthropic, or OpenRouter API key. You choose the exact passage and action, then review its suggestion before applying it. Quire never sends an entire project automatically or rewrites in the background."],
